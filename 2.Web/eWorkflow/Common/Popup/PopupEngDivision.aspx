<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Popup.master" AutoEventWireup="true" CodeFile="PopupEngDivision.aspx.cs" Inherits="Common_Popup_PopupEngDivision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripthead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fn_ReturnToParent(sender, args) {
            var gridSelectdItems = $find('<%= radGridengDivision.ClientID%>').get_masterTableView().get_selectedItems();
        ...
        function fn_OnRowDblClick(sender, args) {
            var gridSelectedItems = $find("<%= radGridengDivision.ClientID %>").get_masterTableView().get_selectedItems();
    ...
    <div id="wrap">
        <div id="pop_content">
            <div class="data_type2 pt20">
                <telerik:RadGrid ID="radGridengDivision" runat="server" AllowPaging="true" AllowSorting="true" PageSize="15" AutoGenerateColumns="false"
                     Skin="EXGrid" OnNeedDataSource="radWinengDivision_NeedDataSource">
