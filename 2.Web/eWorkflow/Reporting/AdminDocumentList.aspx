<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Main.master" AutoEventWireup="true" CodeFile="AdminDocumentList.aspx.cs" Inherits="Reporting_AdminDocumentList" %>
            ...
            <telerik:RadGrid ID="grdSearch" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="true" EnableEmbeddedSkins="false" EnableEmbeddedBaseStylesheet="false" Skin="EXGrid" GridLines="None" AllowMultiRowSelection="false" OnItemDataBound="grdSearch_ItemDataBound" OnNeedDataSource="grdSearch_NeedDataSource">
                <MasterTableView ShowHeadersWhenNoRecords="true" ItemStyle-Wrap="false" TableLayout="Fixed">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Status" DataField="PROCESS_STATUS" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn HeaderText="Final Approver" DataField="FINAL_APPROVER_NAME" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn Display="false" DataField="DOC_NUM" HeaderStyle-Width="120px" ItemStyle-Width="120px">
                        </telerik:GridBoundColumn>
                    </Columns>
                </MasterTableView>
