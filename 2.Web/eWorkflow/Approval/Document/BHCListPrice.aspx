<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Document.master" AutoEventWireup="true" CodeFile="BHCListPrice.aspx.cs" Inherits="Approval_Document_ListPrice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripthead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fn_PopupProduct(sender, args) {
            ...
            var CodeChange = $find('<%= RadrdoCodeChange.ClientID %>').get_checked();
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div id="divCategory" runat="server" style="width: 100%; margin: 0 0 0 0">
                                ...
                                <telerik:RadButton runat="server" ID="RadrdoCodeChange" ButtonType="ToggleButton" ToggleType="Radio" Text="Code Change" Value="Code Change" GroupName="Category" OnClientClicked="fn_Radio" OnClick="RadrdoNew_Click"></telerik:RadButton>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="divBU" runat="server" style="width: 100%; margin: 0 0 0 0">
                                ...
                                <telerik:RadButton ID="radRdoBuDC" runat="server" ButtonType="ToggleButton" ToggleType="Radio" GroupName="BU" Text="DC" Value="DC" AutoPostBack="false" Visible="false"></telerik:RadButton>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadDatePicker runat="server" ID="RadDatePeriodFrom" Calendar-ShowRowHeaders="false" Width="100px" Culture="ko-KR">
                            ...
                            <telerik:RadDatePicker runat="server" ID="RadDatePeriodTo" Calendar-ShowRowHeaders="false" Width="100px" Culture="ko-KR">
                                <DatePopupButton ImageUrl="../../Styles/images/ico_calendar.png" HoverImageUrl="../../Styles/images/ico_calendar.png" />
                                <Calendar runat="server">
                                    <SpecialDays>
                                        <telerik:RadCalendarDay Repeatable="Today" />
            ...
            <telerik:RadGrid runat="server" ID="RadGrdProduct" Skin="EXGrid" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="Center" 
                ...
                <MasterTableView EditMode="Batch">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn DataField="CURRENT_PRICE" UniqueName="CURRENT_PRICE" HeaderText="List Price(-vat)" ColumnGroupName="CurrentPrice" HeaderStyle-Width="120px">
                        ...
                        <telerik:GridTemplateColumn DataField="CURRENT_PRICE_INCLUDE_VAT" UniqueName="CURRENT_PRICE_INCLUDE_VAT" HeaderText="List Price(+vat)" ColumnGroupName="CurrentPrice" HeaderStyle-Width="120px">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn ReadOnly="true" Display="false" DataField="BASE_PRICE" UniqueName="BASE_PRICE" HeaderText="List Price(-vat)" ColumnGroupName="CurrentPrice" HeaderStyle-Width="120px">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn UniqueName="REVISED_PRICE_INCLUDE_VAT" DataField="REVISED_PRICE_INCLUDE_VAT" HeaderText="List Price(+vat)" ColumnGroupName="RevisedPrice" HeaderStyle-Width="120px">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn UniqueName="REVISED_PRICE_EXCLUDE_VAT" DataField="REVISED_PRICE_EXCLUDE_VAT" HeaderText="List Price(-vat)" ColumnGroupName="RevisedPrice" HeaderStyle-Width="120px">
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
