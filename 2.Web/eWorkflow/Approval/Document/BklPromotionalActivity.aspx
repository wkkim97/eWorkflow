<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Document.master" AutoEventWireup="true" CodeFile="BklPromotionalActivity.aspx.cs" Inherits="Approval_Document_PIActivity" %>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadButton ID="radBtnHH" runat="server" Text="HH" Value="HH" GroupName="BG" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClick="RadBusinessGroup_Click">
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnSM" runat="server" Text="SM" Value="SM" GroupName="BG" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClick="RadBusinessGroup_Click">
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnWH" runat="server" Text="WH" Value="WH" GroupName="BG" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClick="RadBusinessGroup_Click" >
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnRAD" runat="server" Text="RAD" Value="RAD" GroupName="BG" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClick="RadBusinessGroup_Click">
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnCH" runat="server" Text="CH" Value="CH" GroupName="BG" AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClick="RadBusinessGroup_Click">
                            </telerik:RadButton>
                        </td>
                    </tr>
<%--                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="divActivityType" style="margin: 0 0 0 0">
                                <telerik:RadButton ID="radBtnProductCampaign" runat="server" Text="Product Campaign" Value="Product Campaign" GroupName="ActivityType" 
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                                </telerik:RadButton>
                                <telerik:RadButton ID="radBtnProfessionalEvent" runat="server" Text="Professional Event" Value="Professional Event" GroupName="ActivityType" 
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                                </telerik:RadButton>
                                <telerik:RadButton ID="radBtnIncentiveProgram" runat="server" Text="Incentive Program(Non-monetary)" Value="Incentive Program(Non-monetary)" GroupName="ActivityType"
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClientCheckedChanged="fn_OnIncentiveCheckedChanged">
                                </telerik:RadButton>
                                <telerik:RadButton ID="radBtnSponsorship" runat="server" Text="Sponsorship(Non-monetary)" Value="Sponsorship(Non-monetary)" GroupName="ActivityType"
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                                </telerik:RadButton>
                                <telerik:RadButton ID="radBtnOther" runat="server" Text="기타(Non-monetary)" Value="기타(Non-monetary)" GroupName="ActivityType" 
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                                </telerik:RadButton>
...
<%--                    <tr>
                    ...
                    <tr>
                        <th>Cost Center & Approval Budget <span class="text_red">*</span></th>
                            <td>
                                <telerik:RadTextBox ID="radTxtCostCenter"  EmptyMessage="복수개의 Cost Center 입력시 세미콜론(;)으로 구분하세요." runat="server" Width="100%"></telerik:RadTextBox>
                            </td>
                        </tr>
                    <tr id="rowProductBrand" >
                        <th>Product Brand <span class="text_red">*</span></th>
                        <td>
                            <telerik:RadDropDownList ID="radDropProductBrand" runat="server" Width="300px" DropDownHeight="300px" DefaultMessage="--- Select ---" AutoPostBack="false">
                                    <Items>
                                        <telerik:DropDownListItem Text="HH-#N/A" Value="HH-#N/A" /> 
                                        <telerik:DropDownListItem Text="SM-#N/A" Value="SM-#N/A" /> 
                                        <telerik:DropDownListItem Text="WH-#N/A" Value="WH-#N/A" /> 
                                        <telerik:DropDownListItem Text="RAD-#N/A" Value="RAD-#N/A" /> 

                                        <telerik:DropDownListItem Text="CH-Aspirin" Value="CH-Aspirin" />          
                                        <telerik:DropDownListItem Text="CH-Bepanthen" Value="CH-Bepanthen" /> 
                                        <telerik:DropDownListItem Text="CH-Bepanthol" Value="CH-Bepanthol" />
                                        <telerik:DropDownListItem Text="CH-Berocca" Value="CH-Berocca" />
                                        <telerik:DropDownListItem Text="CH-Canesten Derm" Value="CH-Canesten Derm" />
                                        <telerik:DropDownListItem Text="CH-Canesten Gyne" Value="CH-Canesten Gyne" />
                                        <telerik:DropDownListItem Text="CH-Clarityne" Value="CH-Clarityne" />
                                        <telerik:DropDownListItem Text="CH-Elevit/Elenew/Menevit" Value="CH-Elevit/Elenew/Menevit" />
                                        <telerik:DropDownListItem Text="CH-One A Day" Value="CH-One A Day" />
                                        <telerik:DropDownListItem Text="CH-Saridon" Value="Saridon" />
                                        <telerik:DropDownListItem Text="CH-Talcid" Value="CH-Talcid" />
            ...
            <div class="title_btn">
                <telerik:RadDropDownList ID="radDdlCategory" runat="server" Width="250px">
                    <Items>
                        ...
                        <telerik:DropDownListItem Text="Honorarium(non-HCP)" Value="0007" />
                        ...
                        <telerik:DropDownListItem Text="DTC Campaign" Value="0012" />
                    </Items>
                </telerik:RadDropDownList>
