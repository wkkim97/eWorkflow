<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Document.master" AutoEventWireup="true" CodeFile="CsExceptionRequest.aspx.cs" Inherits="Approval_Document_CsExceptionRequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripthead" runat="Server">
    <script type="text/javascript">
        ...
        function fn_OnGridKeyUp(sender) {
            ...
            if (dataItem) {
                var qty = 0, price = 0, additional = 0, proposal_price=0,volume=0;
                ...
                dataItem.get_cell('PROPOSAL_PRICE').innerText = (price - additional - ctlVolumn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
               
                dataItem.get_cell('PROPOSAL_AMOUNT').innerText = (qty * (price - additional - ctlVolumn)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        ...
        <div class="data_type1">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadButton ID="radRdoTitle1" runat="server" ButtonType="ToggleButton" ToggleType="Radio" Checked="true"
                            Text="Exception request" Value="Exception" AutoPostBack="false" GroupName="Title" OnClientClicked="fn_OnTitleCheckedChanged">
                        </telerik:RadButton>
                        
                        <telerik:RadButton ID="radRdoTitle2" runat="server" ButtonType="ToggleButton" ToggleType="Radio" Visible="false"
                ...
                <tr>
                    ...
                    <td>
                        <div id="divBG" runat="server" style="width: 100%; margin: 0 0 0 0">
                            <telerik:RadButton ID="radRdoBgCP" runat="server" ButtonType="ToggleButton" ToggleType="Radio" GroupName="BG" Text="CP" Checked="true" Value="CP" AutoPostBack="false" OnClientClicked="fn_OnBgCheckedChanged"></telerik:RadButton>
                            <telerik:RadButton ID="radRdoBgIS" runat="server" ButtonType="ToggleButton" ToggleType="Radio" GroupName="BG" Text="IDS" Visible="true" Value="IS" AutoPostBack="false" OnClientClicked="fn_OnBgCheckedChanged"></telerik:RadButton>
                            ...
                            <telerik:RadButton ID="radRdoBgES" runat="server" ButtonType="ToggleButton" ToggleType="Radio" GroupName="BG" Text="ES"  Visible="true" Value="ES" AutoPostBack="false" OnClientClicked="fn_OnBgCheckedChanged"></telerik:RadButton>
                        </div>
                    </td>
                </tr>
               ...
               <div id="subsidycase" runat="server"  >
                ...
                <telerik:RadGrid ID="radGrdSampleItemList" runat="server" runat="server" AutoGenerateColumns="false"
                    ...
                    <MasterTableView  EditMode="Batch" DataKeyNames="IDX">
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn DataField="INVOICE_PRICE" HeaderText="Inv Price" UniqueName="INVOICE_PRICE" HeaderStyle-Width="80px" >
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn DataField="ADDITIONAL" HeaderText="Additional" UniqueName="ADDITIONAL" HeaderStyle-Width="80px" >
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn DataField="VS_INV" HeaderText="vs INV%" UniqueName="VS_INV" HeaderStyle-Width="80px">
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn DataField="NET2_PRICE" HeaderText="Net Price" UniqueName="NET2_PRICE" HeaderStyle-Width="80px" ReadOnly="true" >
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        * 차액(Total amount - Proposal amount)을 입력합니다.
                    </td>
                </tr>
                <tr>
                    <th>Comment </th>
