...
public partial class Approval_Document_CreditLimitSetting : DNSoft.eWF.FrameWork.Web.WebBase.DocBase
{
        ...
        if (!hddProcessID.Value.Equals(String.Empty))
        {
            using (Bayer.eWF.BSL.Approval.Mgr.CreditLimitSettingMgr mgr = new Bayer.eWF.BSL.Approval.Mgr.CreditLimitSettingMgr())
            {
                ...
                if (doc != null)
                {
                    ...
                    {
                        radBtnBuDC.Visible = true;
                        radBtnBuDC.Checked = true;
                    }
                    else if (doc.BU == "CS")
                    {
                        radBtnBuCS.Visible = true;
                  ...
                  // Divison CS 추가 2017-01-24
                    ...
                    if (doc.BU == this.radBtnBuCS.Value)
                    {
                        ...
                        else if (doc.BUSINESS_GROUP == this.radBtnSub_BVS.Value)
                            this.radBtnSub_BVS.Checked = true;
    ...
    private bool ValidationCheck(ApprovalUtil.ApprovalStatus status)
    {
        ...
        if (status == ApprovalUtil.ApprovalStatus.Request)
        {
            ...
            if (!(radBtnBuPH.Checked || radBtnBuCC.Checked || radBtnBuCH.Checked || radBtnBuAH.Checked || radBtnBuDC.Checked || radBtnBuCS.Checked))
    ...
    private string DocumentSave(string processStatus)
    {
        ...
        if (radBtnBuPH.Checked)
            ...
            else if (radBtnSub_BVS.Checked)
                doc.BUSINESS_GROUP = radBtnSub_BVS.Value;
        ...
        if (radBtnSub_CP.Checked || radBtnSub_IB.Checked || radBtnSub_ES.Checked || radBtnSub_BVS.Checked)
