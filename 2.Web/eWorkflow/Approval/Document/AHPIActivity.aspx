<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Document.master" AutoEventWireup="true" CodeFile="AHPIActivity.aspx.cs" Inherits="Approval_Document_AHPIActivity" %>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadButton ID="radBtnFAP_Swine" runat="server" Text="FAP Swine" Value="FAP Swine" GroupName="BU"
                                AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnFAP_SS" runat="server" Text="FAP SS" Value="FAP SS" GroupName="BU"
                                AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                            </telerik:RadButton>
                            <telerik:RadButton ID="radBtnCAP" runat="server" Text="CAP" Value="CAP" GroupName="BU"
                                AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                            </telerik:RadButton>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div id="divActivityType" style="margin: 0 0 0 0">
                                ...
                                <telerik:RadButton ID="radBtnIncentive" runat="server" Text="Incentive Program (Non-monetary)" Value="IP" GroupName="ActivityType"
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio" OnClientCheckedChanged="fn_OnIncentiveCheckedChanged">
                                </telerik:RadButton>

                                <telerik:RadButton ID="radBtnCampaign" runat="server" Text="Sponsorship (Non-advertisement)" Value="SS" GroupName="ActivityType"
                                    AutoPostBack="false" ButtonType="ToggleButton" ToggleType="Radio">
                                </telerik:RadButton>
                    ...
                    <tr>
                        <th>Cost Center <span class="text_red">*</span></th>
                        <td>
...
<%--                    <tr>
        ...
        <div class="data_type1">
            <h3>Attendee Information (Seminar or Professional Event) </h3>
            <table>
                <colgroup>
                    <col style="width: 25%;" />
                    <col />
