<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocusignCallback.aspx.cs" Inherits="Docusign_DocusignCallback" %>
...
<body>
    ...
    <input id="documentId" type="text" value="" runat="server"/>
    <input id="documentNo" type="text" value="" runat="server"/>
    ...
    <script>
        ...
        function getAccessToken(cb) {
            var loginURL = "/eWorks/Approval/Docusign/Login.aspx?documentId=" + document.getElementById("documentId").value + "&documentNo=" + document.getElementById("documentNo").value;
            var redirectToken = document.getElementById("callbackResult").value;
            if (!redirectToken) location.href = loginURL;
            var svcUrl = "/eWorks/Approval/Docusign/DocusignCallback.aspx/GetAccessToken";
            var data = {
        ...
        function getAccountId(accessToken) {
            var svcUrl = "/eWorks/Approval/Docusign/DocusignCallback.aspx/GetAccountId";
            var data = {
        ...
        function createEnvelope(accessToken) {
            var svcUrl = "/eWorks/Approval/Docusign/DocusignCallback.aspx/CreateEnvelope";
            var data = {
                accessToken: accessToken,
        ...
        function goLivetest(accessToken) {
            var svcUrl = "/eWorks/Approval/Docusign/DocusignCallback.aspx/goLivetest";
            var data = {
                accessToken: accessToken,
