...
public partial class Approval_List_RejectList : DNSoft.eWF.FrameWork.Web.PageBase
{
    ...
    public void Approval_List_RejectList_AjaxRequest(object sender, AjaxRequestEventArgs e)
    {
    ...
    private void GridSource()
    {
        ...
        using (Bayer.eWF.BSL.Approval.Mgr.CommonMgr mgr = new Bayer.eWF.BSL.Approval.Mgr.CommonMgr())
        {
            ...
            grdSearch.DataSource = mgr.SelectApprovalRejectList(condition.DOCUMENT_ID, condition.SUBJECT, chk, condition.FROM_DATE, condition.TO_DATE, Sessions.UserID);
        }
    }
    #endregion
