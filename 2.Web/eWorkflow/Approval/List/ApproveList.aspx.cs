...
public partial class Approval_List_ApproveList : DNSoft.eWF.FrameWork.Web.PageBase
{
    #region Page Load
    ...
    private void GridSource()
    {
        ...
        List<DTO_PROCESS_PROECESSING_LIST> list;

        using (Bayer.eWF.BSL.Approval.Mgr.CommonMgr mgr = new Bayer.eWF.BSL.Approval.Mgr.CommonMgr())
        {
            list = mgr.SelectApprovalProcessList(SearchBar.SearchType, SearchBar.SearchText, chk, SearchBar.StartDate, SearchBar.EndDate, Sessions.UserID);
        }
