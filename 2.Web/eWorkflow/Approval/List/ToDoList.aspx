<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Main.master" AutoEventWireup="true" CodeFile="ToDoList.aspx.cs" Inherits="Approval_List_ToDoList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HolderBody" Runat="Server">
    <div id="content">
        ...
        <div class="board_list pt20" style="min-height:300px">
            <telerik:RadGrid ID="grdSearch" runat="server" AutoGenerateColumns="False" AllowPaging="True" EnableEmbeddedSkins="false" EnableEmbeddedBaseStylesheet="false" Skin="EXGrid"  AllowSorting="true" GridLines="None" AllowMultiRowSelection="false" OnNeedDataSource="grdSearch_NeedDataSource">
                <MasterTableView ShowHeadersWhenNoRecords="true" ItemStyle-Wrap="false" TableLayout="Fixed">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Req Date" DataField="REQUEST_DATE" DataFormatString="{0:yyyy-MM-dd}" HeaderStyle-Width="90px" ItemStyle-Width="90px" >
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn HeaderText="Next Approver" DataField="NEXT_APPROVER_NAME" HeaderStyle-Width="120px" ItemStyle-Width="120px" >
                        </telerik:GridBoundColumn>
                    </Columns>
                </MasterTableView>
