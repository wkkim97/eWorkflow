<%@ Page Title="" Language="C#" MasterPageFile="~/Master/eWorks_Main.master" AutoEventWireup="true" CodeFile="WithdrawList.aspx.cs" Inherits="Approval_List_WithdrawList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HolderHead" Runat="Server">
    ...
    <telerik:RadAjaxManager ID="ajaxMgr" runat="server" OnAjaxRequest="Approval_List_WithdrawList_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:RadGrid ID="grdSearch" runat="server" AutoGenerateColumns="False" AllowPaging="True" EnableEmbeddedSkins="false" EnableEmbeddedBaseStylesheet="false" Skin="EXGrid" AllowSorting="true" GridLines="None" AllowMultiRowSelection="false" OnNeedDataSource="grdSearch_NeedDataSource">
                <MasterTableView ShowHeadersWhenNoRecords="true" ItemStyle-Wrap="false" TableLayout="Fixed">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Recipient" DataField="CURRENT_APPROVER_NAME" HeaderStyle-Width="120px" ItemStyle-Width="120px" >
                        </telerik:GridBoundColumn>
                    </Columns>
                </MasterTableView>
